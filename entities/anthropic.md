...
> 原文备份见 `_archive/hub-rewrite-2026-09-07/anthropic.md`，一手来源仍见下方 sources。
...
- [[entities/natural-language-autoencoders|Natural Language Autoencoders — Anthropic 激活→文字可解释性方法]] — NLA激活翻译：错位审计12-15% vs <3% rv9
...
- [[entities/agent-memory-injection-5-dimensions-4-papers-agent-shouji-2026|Agent 记忆注入实战：5 维框架（选什么/放哪里/怎么放/放多少/何时放）+ 4 前沿论文（MemGuide/STITCH/ACE/Lost in the Middle）]] — 记忆注入5维框架
- [[entities/skill-design-patterns-anthropic|Anthropic 官方 14 种 Skill 设计模式]] — 官方14种设计模式详解
...
- [[entities/claude-opus-48-system-card-analysis|Claude Opus 4.8 系统卡片深度分析]] — RSP放松批判
