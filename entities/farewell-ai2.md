...
type: entity
tags: [training]
sources: [raw/articles/farewell-ai2]
review_value: 7
review_confidence: 8
...
→ [[raw/articles/farewell-ai2|原文存档]]

# Farewell Ai2

I’m departing the Allen Institute for AI (Ai2), where I got the great privilege to work on the Olmo models, to grow, to learn, and to have broad lasting impacts. This post is an attempt to reflect on why what we did was influential, despite obviously being far from the frontier in performance (even when within size buckets), and how this reflects on various paths to impact in AI today. ^[raw/articles/farewell-ai2.md]

To start, I shared the following note with the company yesterday: ^[raw/articles/farewell-ai2.md]
...
I have loved and will still love Ai2. Ai2 has a deep culture of caring about the research process, the outputs that get shared, and most importantly the people who do the work. This ^[raw/articles/farewell-ai2.md]
