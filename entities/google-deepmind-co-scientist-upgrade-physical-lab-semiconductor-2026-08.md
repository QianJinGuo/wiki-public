...
Google DeepMind 与杜克大学联合发布了 AI 科研系统 Co-Scientist 的重大升级版本。Co-Scientist 是 Google 基于 Gemini 构建的多智能体科研系统，此前版本主要聚焦于计算机内的假设生成。此次升级的核心突破在于：**Co-Scientist 首次成为一个以真实实验执行为基础的闭环科研伙伴**。

## 核心突破

### 从"想"到"做"的范式转变

当前 AI 科研面临的最大瓶颈：「AI 能在计算中提出什么」与「能在物理世界中验证什么」之间的鸿沟。
...
→ [[raw/articles/google-deepmind-co-scientist-upgrade-physical-lab-semiconductor-2026-08|原文存档]]
